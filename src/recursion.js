...
// var arraySum = function(array) {
  var flattened = array.reduce(function(arr, cur) {
    return Array.isArray(cur)? arr.concat(arraySum(cur)) : arr.concat(cur);
      }, []);
...
var reverseArr = function(array) {
  ...
  arr.push(array[0]);
  return reverseArr(array.slice(1, array.length)).concat(arr);
...
var fibonacci = function(n) {
  ...
  // return arr.concat(fibonacci(n - 1));
};
...
return arr.push((arr[arr.length - 1] + arr[arr.length - 2])) = [1]
...
var capitalizeFirst = function(array) {
  ...
  var firstWord = firstLetter + array[0].slice(1);
  arr.push(firstWord);
